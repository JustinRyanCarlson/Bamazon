...
INSERT INTO `products` (`item_id`, `product_name`, `department_name`, `price`, `stock_quanity`) VALUES (NULL, 'nonda USB-C to USB 3.0 Mini Adapter [World?s Smallest] Aluminum Body with Indicator LED for Macbook Pro 2016, MacBook 12-inch and other Type-C Devices (Space Gray)', 'Amazon Launchpad Computers', '10.99', '64');
